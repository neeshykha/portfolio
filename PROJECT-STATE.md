...
| 3 | MQD calculator ("MQD Runway") | **LIVE 2026-09-14** — https://neeshykha.github.io/mqd-calculator/ | Repo `neeshykha/mqd-calculator`, Pages main/root, About set. Rules encoded as editable data (Sept 2026 snapshot: 5k/10k/15k/28k thresholds, unchanged for 2027 per Dec-2025 Delta announcement; Headstart $2,500/card; Boost $10 Reserve / $20 Platinum). Fixed a "-0 MQD" display bug on exact tier ties before publishing. **Rules snapshot re-verified 2026-09-21** against delta.com's how-to-qualify page and the Dec-2025 announcement: 5k/10k/15k/28k unchanged for 2027, Headstart $2,500 per eligible card, Boost 1 MQD per $10 Reserve and per $20 Platinum. All correct. Delta also caps Headstart at $10,000 across four eligible cards, which the tool already enforces structurally, since its `CARDS` list is exactly those four. **One unmodeled path:** Delta relaunched "Elevate Your Status," a targeted offer to buy MQDs at roughly $3 each. It's invitation-only, so it can't be a general gap-closing lane, but it's a candidate for a v2 toggle. Audience play (r/delta first, then FlyerTalk) drafted 2026-09-21; posting is Aneesh's, under his accounts. |
